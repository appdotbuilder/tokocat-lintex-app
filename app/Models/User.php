 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\RawMaterialTransaction> $rawMaterialTransactions
...
class User extends Authenticatable
{
    ...
    /**
     * Get the raw material transactions for the user.
     */
